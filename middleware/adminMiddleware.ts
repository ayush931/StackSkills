...
export const authenticateAdmin = (handler: (req: AdminAuthenticatedRequest) => Promise<NextResponse>) => {
...
export const requireSuperAdmin = (handler: (req: AdminAuthenticatedRequest) => Promise<NextResponse>) => {
